...
/**
 * REST controller for managing {@link com.xupinc.tms.v1.domain.BookingItem}.
 */
@RestController
@RequestMapping("/api")
public class BookingItemResource {
    ...
    public ResponseEntity<BookingItem> updateBookingItem(@RequestBody BookingItem bookingItem) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, bookingItem.getId().toString()))
            .body(result);
    }
